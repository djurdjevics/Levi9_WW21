...
import { PrivateRouteGuest } from "../hoc/privateRouteGuest";
import { PrivateRouteAdminSuperUserAndUser } from "../hoc/privateRouteAdminSuperUserAndUser";
import SignUp from "./../user/SignUp";
import AllCurrentProjections from "../user/AllCurrentProjections";
import Top10IMBD from "../Top10IMBD";
    ...
    <Row className="justify-content-center no-gutters">
      ...
      <Col className="pt-2 app-content-main">
        <Switch>
          ...
          <Route path="/dashboard/Top10IMBD" component={Top10IMBD} />
          <PrivateRouteGuest 
