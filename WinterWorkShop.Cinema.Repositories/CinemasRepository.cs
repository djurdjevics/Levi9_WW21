...
namespace WinterWorkShop.Cinema.Repositories
{
    ...
    {
        Task<Data.Cinema> GetByCinemaName(string name);
    }
    ...
    public class CinemasRepository : ICinemasRepository
    {
        ...
        public async Task<Data.Cinema> GetByCinemaName(string name)
        {
            var data = await _cinemaContext.Cinemas.SingleOrDefaultAsync(x => x.Name == name);
